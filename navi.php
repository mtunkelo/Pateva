...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a href="lisaaKurssi.php">LISÄÄ KURSSI</a></li>
					<li><a href="listaaKurssit.php">KAIKKI KURSSIT</a></li>
					<li><a href="haeKurssi.php">KURSSIHAKU</a></li>
	...
	<div class="jumbotron text-center">
		<h1>PÄTEVÄ</h1>
		<p>Ketterää pätevyyksien hallintaa</p>
	</div>